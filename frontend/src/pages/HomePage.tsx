...
export const HomePage: React.FC = () => {
  ...
  const activeFilter = 'border-[#8B5CF6]/45 bg-[#8B5CF6]/[0.08] text-[#C4B5FD] shadow-none';
  const inactiveFilter = 'border-white/[0.07] bg-transparent text-[#94A3B8] hover:border-white/[0.12] hover:bg-white/[0.025] hover:text-[#CBD5E1]';
