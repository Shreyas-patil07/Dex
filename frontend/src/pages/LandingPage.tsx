    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#080810] text-white">
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
        <svg className="absolute -left-[20%] -top-[8%] h-[116%] w-[140%]" viewBox="0 0 1200 700" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="M-700 590C-250 120 120 40 560 190C1000 340 1370 570 2050 150" stroke="#7C3AED" strokeWidth="1.2" strokeLinecap="round" opacity="0.19">
            <animateTransform attributeName="transform" type="translate" values="-220 90;220 -90;-220 90" dur="12s" repeatCount="indefinite" />
          </path>
          <path d="M-750 210C-280 650 160 650 610 360C1050 75 1450 120 2050 520" stroke="#A855F7" strokeWidth="0.9" strokeLinecap="round" opacity="0.17">
            <animateTransform attributeName="transform" type="translate" values="220 -110;-220 110;220 -110" dur="16s" repeatCount="indefinite" />
          </path>
          <path d="M-500 850C-100 420 300 280 700 450C1080 610 1450 420 1900 -20" stroke="#2DD4BF" strokeWidth="0.7" strokeLinecap="round" opacity="0.14">
            <animateTransform attributeName="transform" type="translate" values="-160 120;160 -120;-160 120" dur="20s" repeatCount="indefinite" />
          </path>
        </svg>
      </div>
      ...
      <main className="relative z-10">
        <section className="flex min-h-[calc(100vh-92px)] flex-col items-center justify-center px-6 text-center">
          <h1 className="max-w-4xl text-4xl font-display font-extrabold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">
            Welcome to your <span className="bg-gradient-to-r from-[#A855F7] via-[#C084FC] to-[#2DD4BF] bg-clip-text text-transparent">Memories</span>
          </h1>
        ...
        <section className="mx-auto max-w-6xl px-6 py-24 text-center sm:py-32"><p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#A855F7]">Your taste, over time</p><h2 className="mx-auto mt-4 max-w-3xl text-3xl font-bold tracking-tight sm:text-5xl">Every watch tells Dex a little more about you.</h2><p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#94A3B8] sm:text-lg">Build your history, understand your patterns, discover new favorites, and watch your entertainment identity evolve.</p><button className="mt-8 rounded-xl bg-[#7C3AED] px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#6D28D9]">Create your Dex</button></section>
      </main>
