    ...
    <div className="min-h-screen w-full flex flex-col bg-[#080810]">
      <header className="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="px-2 py-2 text-sm font-semibold text-[#A855F7] hover:text-[#C084FC] transition-colors cursor-pointer">
            Login
          </button>
          <button className="px-5 py-2 rounded-xl bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-sm font-semibold transition-colors cursor-pointer">
            Sign Up
          </button>
        </div>
      </header>
