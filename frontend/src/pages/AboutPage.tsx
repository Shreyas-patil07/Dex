...
export const AboutPage: React.FC = () => (
  <div className="relative min-h-screen w-full overflow-x-hidden bg-[#080810] text-white">
    ...
    <header className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-5 sm:py-6"><a href="/"><img src="/DEXi.png" alt="Dex" className="h-14 w-14 object-contain sm:h-12 sm:w-22" /></a><div className="flex items-center gap-3 sm:gap-5"><a href="/sign-up" className="rounded-lg px-3 py-2 text-sm font-semibold text-[#A855F7] hover:text-[#C084FC]">Login</a><a href="/sign-up" className="rounded-xl bg-[#7C3AED] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#6D28D9]">Sign Up</a></div></header>
    <main className="relative z-10">
      <section className="flex min-h-[calc(100vh-92px)] flex-col items-center justify-center px-6 text-center"><h1 className="max-w-4xl text-4xl font-display font-extrabold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">Welcome to your <span className="bg-gradient-to-r from-[#A855F7] via-[#C084FC] to-[#2DD4BF] bg-clip-text text-transparent">Memories</span></h1><p className="mt-6 max-w-3xl text-xl font-medium tracking-wide text-[#94A3B8] sm:text-2xl lg:text-3xl">Explore yourself through what you watch.</p><a href="/sign-up" className="mt-9 rounded-xl bg-[#7C3AED] px-7 py-3 text-sm font-semibold text-white hover:bg-[#6D28D9]">Start exploring</a></section>
